...
var createImage = function () {
    nightmare.goto('file://' + __dirname + path.normalize('/node_modules/morpheus-app/index.html')).evaluate(function (options, outputFile, outputFormat) {
        ...
        return promise;
    }, options, outputFile, outputFormat).then(function (value) {
...
// ensure tools are not run in background
if (options.tools) {
